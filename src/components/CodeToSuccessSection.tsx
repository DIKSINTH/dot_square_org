    ...
    <section className="px-4 mb-3 sm:px-6 sm:mb-6 lg:px-8 lg:mb-10">
      ...
      >
        ...
        <div className="relative z-10">
          <button className="flex items-center gap-2 bg-[#064354] text-white px-5 sm:px-6 lg:px-8 py-3 rounded-lg font-semibold text-sm sm:text-base lg:text-lg hover:bg-[#126880] transition-colors">
